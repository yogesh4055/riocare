                        ...
                        @if (isset($batch) && $batch)
                            ...
                            <li class="dropdown"><a role="tab" class="dropdown-toggle" data-toggle="dropdown"
                                ...
                                <ul class="dropdown-menu">
                                    ...
                                    <li><a role="tab" data-toggle="tab" href="#requisitionFinishGood">Requisition</a></li>
                                    <li><a role="tab" data-toggle="tab" href="#issualFinishGood">Issual of requisition</a></li>
            ...
            $(add_button).click(function(e) { //on add input button click
                ...
                if (x < max_fields) { //max input box allowed
                    ...
                    $(wrapper).append(
                        ...
                        x + '" placeholder="" onkeypress="return validateNumber(event);"></div></div></div></div>'); //add input box
                }
                feather.replace()
            });
        ...
        $(document).ready(function() {
            ...
            $("#add_manufacturing").validate({
                ...
                messages: {
                    ...
                    bmrNoo: "Please  Enter The Name bmrNo",
