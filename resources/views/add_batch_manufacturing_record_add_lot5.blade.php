				...
				<div class="form-row">
					...
					<div class="col-12 col-md-6 col-lg-4">
						<div class="form-group">
						  ...
						  <input type="text" class="form-control" id="lotNo" placeholder="Lot No." value="5">
						</div>
					</div>
					<div class="col-12 col-md-6 col-lg-4">
						<div class="form-group">
					...
					<div class="col-12">
						<div class="form-group">
						  <button type="submit" class="btn btn-primary btn-md ml-0 form-btn waves-effect waves-light">Save &amp; Quite</button><a href="{{url('add-batch-manufacturing-record-process-chec-5')}}" class="btn btn-dark btn-md form-btn waves-effect waves-light">Calculate Quantity</a>
						</div>
					</div>
				</div>
			</div>
