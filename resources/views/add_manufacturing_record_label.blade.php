						...
						<div class="form-group input_fields_wrap" id="MaterialReceived">
							...
							<div class="row add-more-wrap after-add-more m-0 mb-4">
								...
								<div class="col-12 text-center mb-3">
									<h4>ACTIVATED SIMETHICONE - 100%</h4>
								</div>
								<div class="col-12 text-center mb-3">
									<h4>FILIX-110</h4>
								</div>
								<div class="col-12 col-md-6">
									<div class="form-group">
									  <label for="LabelBatchNo" class="active">Batch No.</label>
									  <input type="text" class="form-control" id="LabelBatchNo" placeholder="Batch No." value="RFLX 20/668">
									</div>
								</div>
								<div class="col-12 col-md-6 flex-clear">
									<div class="form-group">
									  <label for="mfg" class="active">MFG Date</label>
									  <input type="date" class="form-control calendar" id="mfg" placeholder="DD/MM/YYYY">
									</div>
								</div>
								<div class="col-12 col-md-6 col-lg-4">
									<div class="form-group">
									  <label for="netWeight" class="active">Net Weight (Kg.)</label>
									  <input type="text" class="form-control" id="netWeight" placeholder="">
									</div>
								</div>
								<div class="col-12 col-md-6 col-lg-4">
									<div class="form-group">
									  <label for="retest" class="active">Retest Date</label>
									  <input type="date" class="form-control" id="retest" placeholder="">
									</div>
								</div>
								<div class="col-12 col-md-6 col-lg-4">
									<div class="form-group">
									  <label for="tareWt" class="active">Tare Wt. (Kg.)</label>
									  <input type="Number" class="form-control" id="tareWt" placeholder="">
									</div>
								</div>
							</div>
						</div>
