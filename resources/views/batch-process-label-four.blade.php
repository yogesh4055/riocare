			...
			<!-- Main Container -->
				<div style="display:block;padding:20px;border:2px solid #000;min-height:15.2in;position: relative">
						...
						@if(isset($manufacture) && $manufacture)
							...
							@if(isset($lables) && $lables)
									<div style="padding:1rem 0;text-align:center;text-decoration:underline;font-size:1.4rem;font-weight:bold;color:#313131;">PRODUCT LABEL 25 kg Bags</div>
