...
@if($lables->net_wt_50 !='' || $lables->tare_wt_50 !='')
			...
			<!-- Main Container -->
				<div style="display:block;padding:20px;border:2px solid #000;min-height:15.2in;position: relative">
						...
						@if(isset($manufacture) && $manufacture)
							...
							@if(isset($lables) && $lables)
									<div style="padding:1rem 0;text-align:center;text-decoration:underline;font-size:1.4rem;font-weight:bold;color:#313131;">PRODUCT LABEL 50 kg Drums</div>
												...
												<td>
													<table width="auto" cellpadding="5" cellspacing="0" border="0" style="font-size:1.1rem;font-weight:bold;font-family: serif;margin:0 1.2rem 0rem;line-height:1.1;text-align:left !important;">
														...
														<tr>
															<td>NET WT</td>
															<td>:</td>
															@if(!empty($lables->net_wt_50))
															<td>{{$lables->net_wt_50}} KG</td>
															@else
															<td>0 KG</td>
															@endif
														...
														<tr>
															<td>TARE WT</td>
															<td>:</td>
															@if(!empty($lables->tare_wt_50))
															<td>{{$lables->tare_wt_50}} KG</td>
															@else
															<td>0 KG</td>
															@endif
														</tr>
		...
		@if((isset($lables->net_wt_30) || isset($lables->net_wt_5)))
