@if(isset($lables) && $lables)
	...
	@if($lables->net_wt_200 !='' || $lables->tare_wt_200 !='')
				...
				<div style="display:block;padding:20px;border:2px solid #000;height:15.2in;position: relative">
						<table width="100%" cellpadding="10" cellspacing="0" border="0">
							<tr>
								...
								<td style="text-align:center;"><h2 style="font-family: serif;font-size: 2rem;">RioCare India Private Limited</h2><p style="font-family: serif;font-size:1rem;font-weight:bold;">Plot R-940,TTC Industrial Area,MIDC Rabale,Navi Mumbai, District : Thane-400701,District Thane,Maharashtra ,INDIA.</p></td>
								<td width="80">&nbsp;</td>
							</tr>
						</table>
						...
						@if(isset($manufacture) && $manufacture)
							...
							@if(isset($lables) && $lables)
									<div style="padding:1rem 0;text-align:center;text-decoration:underline;font-size:1.4rem;font-weight:bold;color:#313131;">PRODUCT LABEL 200 kg Drums</div>
												...
												<td>
													<table width="auto" cellpadding="5" cellspacing="0" border="0" style="font-size:1.1rem;font-weight:bold;font-family: serif;margin:0 1.2rem 0rem;line-height:1.1;text-align:left !important;">
														...
														<tr>
															<td>RETEST DATE</td>
															<td>:</td>
															<td>{{ date("d-m-Y", strtotime($lables->retest_date))}}</td>
														</tr>
													</table>
												</td>
												<td>
													<table width="auto" cellpadding="5" cellspacing="0" border="0" style="font-size:1.1rem;font-weight:bold;font-family: serif;margin:0 1.2rem 0rem;line-height:1.1;text-align:left !important;">
														...
														<tr>
															<td>NET WT</td>
															<td>:</td>
															@if(!empty($lables->net_wt_200))
															<td>{{$lables->net_wt_200}} KG</td>
															@else
															<td></td>
															@endif
														</tr>
														<tr>
															<td>TARE WT</td>
															<td>:</td>
															@if(!empty($lables->tare_wt_200))
															<td>{{$lables->tare_wt_200}} KG</td>
															@else
															<td></td>
															@endif
														</tr>
		...
		@if((isset($lables->net_wt_50) || isset($lables->net_wt_30) || isset($lables->net_wt_5)))
