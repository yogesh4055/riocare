    ...
    <div style="display:block;padding:20px;border:2px solid #000;min-height:11.7in;">
				...
				<td>
					<table width="auto" cellpadding="5" cellspacing="0" border="0" style="font-size:1.1rem;font-weight:bold;font-family: serif;margin:0 1.2rem 0rem;line-height:1.2;">
						<tr>
							<td>BMR No.</td>
							<td>:</td>
							<td>RCIPL/BMR/Flx-2300/10</td>
						</tr>
						<tr>
							<td>Ref. MFR No.</td>
							<td>:</td>
							<td>RCIPL/MFR/01/01</td>
						</tr>
					</table>
				</td>
			</tr>
			...
			<tr>
				<td>
					<table width="100%	" cellpadding="5" cellspacing="0" border="0" style="font-size:1.1rem;font-weight:bold;font-family: serif;margin:0 1.2rem 0rem;line-height:1.2;">
						<tr>
							<td width="30%">Lot No.: 3</td>
							<td>Reactor No.: <span style="font-weight:400;">PR/RC/001 - PR/RC/002</span></td>
							<td width="30%">Date:</td>
						</tr>
					</table>
				</td>
		...
		<table class="table table-bordered">
			<thead>
				...
				<tr>
					<td>Charges Polydimethyl siloxane in reactor.</td>
					<td>&nbsp;</td>
					<td>&nbsp;</td>
					<td>&nbsp;</td>
					<td>&nbsp;</td>
				...
				<tr>
					<td>Once the temperature is between 100 - 120oC starts the Inline mixer and charges ColloidalSilicon Dioxide (Fumed Silica) in reactor simultaneously and increase stirring speed.</td>
					<td>&nbsp;</td>
					<td>&nbsp;</td>
					<td>&nbsp;</td>
					<td>&nbsp;</td>
