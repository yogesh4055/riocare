                ...
                <table class="table table-hover table-bordered datatable">
                    ...
                    <tbody>
                        ...
                        <tr>
                            <td> {{$temp->id}}</td>
                            <td> {{$temp->batchNo}}</td>
                            <td> {{($temp->type=='P')?'Packing Material':(($temp->type=='R')?'Raw Material': 'Finished Goods')}}</td>
                           ...
                           @else
                           <a href="{{ route('issue_material',['id'=>$temp->id]) }}" class="btn action-btn" title="Approved Qty"><i data-feather="eye"></i></a>
                           @endif
