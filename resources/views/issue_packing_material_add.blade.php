        ...
        <div class="card-body">
            ...
            {{csrf_field()}}
                <div class="form-row">
                    ...
                    <div class="col-12 col-md-6 col-lg-6 col-xl-6">
                        <div class="form-group">
                            <label for="MaterialName">Packing Material Name</label>
                    ...
                    <div class="col-12 col-md-6 col-lg-6 col-xl-6">
                        <div class="form-group">
                            <label for="RawBatchNo">Packing Material GRN No.</label>
                            {{ Form::select("batch_no",array(),old("batch_no"),array("class"=>"form-control select","id"=>"batch_no","placeholder"=>"Choose GRN No")) }}
