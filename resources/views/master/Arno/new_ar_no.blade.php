...
@section('content')
    ...
    <div class="card main-card">
        <div class="card-body">
            <form class="login100-form validate-form" action="{{ url('ar_no_insert') }}" method="POST" id="ar_no_vali">
                @csrf
                <div class="form-row">
                    <div class="col-12 col-md-6 col-lg-6 col-xl-6">
                        <div class="form-group">
                            <label for="rno">AR.No</label>
                            <input type="text" class="form-control" name="name" id="name" placeholder="AR. No" >
                            @if ($errors->has('name'))
