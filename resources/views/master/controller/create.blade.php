...
@section('content')
        ...
        <div class="col-md-12 grid-margin">
            <div class="row page-heading">
                <div class="col-12 col-xl-8 mb-xl-0 align-self-center align-items-center">
                    <h4 class="font-weight-bold d-flex"><i class="menu-icon" data-feather="layers"></i>New Controller</h4>
    ...
    <div class="card main-card">
        <div class="card-body">
            <form class="login100-form validate-form" action="{{ route('controller-store') }}" method="POST" id="departmentForm">
                @csrf
                <div class="form-row">
                    <div class="col-12 col-md-12 col-lg-12 col-xl-12">
                        <div class="form-group">
                            <label for="rno">Controller Name</label>
                            <input type="text" class="form-control" name="controller" id="controller" placeholder="Controller Name" value="{{ old("controller") }}">
                    ...
                    <div class="col-12 col-md-6 col-lg-6 col-xl-6">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" name="menuname" id="menuname" placeholder="Menu Name" value="{{ old("menuname") }}">
                    ...
                    <div class="col-12 col-md-6 col-lg-6 col-xl-6">
                        <div class="form-group">
                            ...
                            {{ Form::select("parent",$menus,old("parent"),array("id"=>"parent","class"=>"form-control","placeholder"=>"Parent Menu")) }}
                    ...
                    <div class="col-12 col-md-6 col-lg-6 col-xl-6">
                        <div class="form-group">
                            ...
                            <input type="number" class="form-control" name="menuorder" id="menuorder" placeholder="Menu Order" value="{{ old("menuorder") }}">
