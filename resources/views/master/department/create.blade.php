                ...
                <div class="form-row">
                    <div class="col-12 col-md-6 col-lg-6 col-xl-6">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" name="department" pattern="\d*" maxlength="15" onkeypress="return /[0-9a-zA-Z\s\\/-]/i.test(event.key)" id="department" placeholder="Department Name" value="{{ old("department") }}">
