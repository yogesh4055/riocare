    ...
    <div class="col-md-12 grid-margin">
      <div class="row page-heading">
        <div class="col-12 col-lg-8 mb-xl-0 align-self-center align-items-center">
          <h4 class="font-weight-bold d-flex"><i class="menu-icon" data-feather="package"></i>Designation</h4>
        </div>
        <div class="col-12 col-lg-2 ml-auto align-self-center align-items-end text-right">
          <a href="{{ route("new-designation") }}" class="btn btn-md btn-primary">Add New +</a>
        </div>
      </div>
    </div>
  </div>
            ...
            <table class="table table-hover table-bordered datatable">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td class="actions"><a href="{{ route("edit-designation",["id"=>$val->id]) }}" class="btn action-btn" data-toggle="tooltip" title="Edit"><i data-feather="edit-3"></i></a><a href="#" class="btn action-btn" data-toggle="tooltip" class="remove" data-href="" title="Delete" onclick="remove('{{ route("delete-designation",["id"=>$val->id]) }}')"><i data-feather="trash"></i></a></td>
                    </tr>
                        @php($i++)
                        @endforeach
                    @endif
