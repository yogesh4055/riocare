...
@section('content')
        ...
        <div class="col-md-12 grid-margin">
            <div class="row page-heading">
                <div class="col-12 col-xl-8 mb-xl-0 align-self-center align-items-center">
                    <h4 class="font-weight-bold d-flex"><i class="menu-icon" data-feather="layers"></i>New Mode of Dispatch</h4>
    ...
    <div class="card main-card">
        <div class="card-body">
            <form class="login100-form validate-form" action="{{ route('modedispatch-store') }}" method="POST" id="departmentForm">
                @csrf
                <div class="form-row">
