...
@section('content')
    ...
    <div class="card main-card">
        <div class="card-body">
            ...
            <form class="login100-form validate-form" action="{{ route('rawmaterial-store') }}" method="POST"
                id="departmentForm">
                @csrf
                <div class="form-row">
                    <div class="col-12 col-md-6 col-lg-6 col-xl-6">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" name="rawmeterial" id="rawmeterial"
                                placeholder="Material Name" value="{{ old('rawmeterial') }}">
                    ...
                    <div class="col-12 col-md-6 col-lg-6 col-xl-6">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" name="rawmeterial_code" id="rawmeterial_code"
                                placeholder="Material Code" value="{{ old('rawmeterial_code') }}">
                    ...
                    <div class="col-12 col-md-6 col-lg-6 col-xl-6">
                        <div class="form-group">
                            ...
                            {{ Form::select('mesurment', $mesurments, old('mesurment'), ['id' => 'mesurment', 'class' => 'form-control', 'placeholder' => 'Material Mesurment']) }}
                    ...
                    <div class="col-12 col-md-6 col-lg-6 col-xl-6 ">
                        <div class="form-group ">
                            ...
                            {{ Form::select('type', $type, old('type'), ['id' => 'type', 'class' => 'form-control  material_type', 'placeholder' => 'Material Type']) }}
                            @if ($errors->has('mesurment'))
                                <span class="text-danger">{{ $errors->first('mesurment') }}</span>
                            @endif
                    ...
                    <div class="col-12 col-md-6 col-lg-6 col-xl-6">
                        <div class="form-group">
                            ...
                            <input type="number" class="form-control" name="prestock" id="prestock"
                                placeholder="Material Preorder Stock" value="{{ old('prestock') }}">
                ...
                <div class="form-row" id="finalprod" style="display: none;">
                        ...
                        <div class="col-12 col-md-6 col-lg-6 col-xl-6">
                            <div class="form-group">
                                ...
                                <div class="form-check form-check-inline">
                                    <input class="form-check-input" type="radio" name="processgroupid" id="inlineRadio1" value="1">
                    ...
                    @endif
                        ...
                        @if(isset($procgroup) && isset($procgroup[2]))
                                <div class="col-12 col-md-6 col-lg-6 col-xl-6">
                                    <div class="form-group">
                                        <div class="form-check ">
                                            <input class="form-check-input" type="radio" name="processgroupid" id="inlineRadio2" value="2">
                            ...
                            <div class="col-12 col-md-6 col-lg-6 col-xl-6" style="margin-top:30px">
                                <div class="form-group">
                                    <div class="form-check ">
                                        <input class="form-check-input" type="radio" name="processgroupid" id="inlineRadio3" value="3">
                        ...
                        <!--        <div class="form-group">-->
                        <!--            <div class="form-check ">-->
                        <!--                <input class="form-check-input" type="radio" name="processgroupid" id="inlineRadio4" value="4">-->
                        ...
                        @if(isset($procgroup) && isset($procgroup[5]))
                            <div class="col-12 col-md-6 col-lg-6 col-xl-6" style="margin-top:10px">
                                <div class="form-group">
                                    <div class="form-check ">
                                        <input class="form-check-input" type="radio" name="processgroupid" id="inlineRadio5" value="5">
                        ...
                        @if(isset($procgroup) && isset($procgroup[6]))
                            <div class="col-12 col-md-12 col-lg-12 col-xl-12" style="margin-top:10px">
                                <div class="form-group">
                                    <div class="form-check ">
                                        <input class="form-check-input" type="radio" name="processgroupid" id="inlineRadio6" value="6">
                        ...
                        <div class="col-12 col-md-6 col-lg-6 col-xl-6">
                            <div class="form-group">
                                ...
                                <div class="form-check form-check-inline">
                                    <input class="form-check-input" type="radio" name="reactorstatusgroup" id="reactorstatusgroup1" value="1">
                    ...
                    @if(isset($reactgroup) && isset($reactgroup[2]))
                            <div class="col-12 col-md-6 col-lg-6 col-xl-6" style="margin-top:30px">
                                <div class="form-group">
                                    <div class="form-check ">
                                        <input class="form-check-input" type="radio" name="reactorstatusgroup" id="reactorstatusgroup2" value="2">
                        ...
                        @if(isset($reactgroup) && isset($reactgroup[3]))
                            <div class="col-12 col-md-6 col-lg-6 col-xl-6" style="margin-top:30px">
                                <div class="form-group">
                                    <div class="form-check ">
                                        <input class="form-check-input" type="radio" name="reactorstatusgroup" id="reactorstatusgroup3" value="3">
                        ...
                        @if(isset($reactgroup) && isset($reactgroup[4]))
                            <div class="col-12 col-md-6 col-lg-6 col-xl-6" style="margin-top:30px">
                                <div class="form-group"><br>
                                    <div class="form-check ">
                                        <input class="form-check-input" type="radio" name="reactorstatusgroup" id="reactorstatusgroup4" value="4">
                        ...
                        @if(isset($reactgroup) && isset($reactgroup[5]))
                            <div class="col-12 col-md-6 col-lg-6 col-xl-6" style="margin-top:30px">
                                <div class="form-group"><br>
                                    <div class="form-check ">
                                        <input class="form-check-input" type="radio" name="reactorstatusgroup" id="reactorstatusgroup5" value="5">
    ...
    <script>
        ...
        $(".material_type").change(function() {
            ...
            if (id == 'P') {
                ...
                var capacity =
                    '<div class="form-group"> <label for="controller_id">Capacity</label><input type="number" class="form-control" name="capacity" id="capacity" placeholder="Capacity Opening Stock" value="{{ old('stock') }}"></div>';
