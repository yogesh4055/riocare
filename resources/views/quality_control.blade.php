                        ...
                        <table class="table table-hover table-bordered datatable">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>{{$temp->checkar}} / {{($temp->checkardate != "0000-00-00 00:00:00" && $temp->checkardate)?date("d/m/Y",strtotime($temp->checkardate)):""}}</td>
                                    ...
                                    <td>
                                        ...
                                        <a href="#" data-toggle="modal" title="View" data-target="#checkquality" id="qty_control" data-id="{{ $temp->itemid }}"  onclick="qualitycontrol('{{$temp->itemid}}','add')"class="btn btn-primary btn-sm">&nbsp;&nbsp;&nbsp;Check&nbsp;&nbsp;&nbsp;</a>
                                       @else
                                       <p> No Permision</p>
                                        @endcan
                                        ...
                                        <a href="#" data-toggle="modal" title="Edit" data-target="#checkquality" id="qty_control" data-id="{{ $temp->itemid }}"  onclick="qualitycontrol('{{$temp->itemid}}','edit')"class="btn action-btn"><i data-feather="edit-3"></i></a>
                                        @endif
                                    </td>
...
<script src="https://cdn.datatables.net/1.10.24/js/dataTables.bootstrap4.min.js"></script>
  ...
  <script src="{{ asset('assets/js/custom.js')  }}"></script>
    <script>
        ...
        function qualitycontrol(quality_id,flag)
        {
        $.ajax({
