        ...
        <div class="filter">
            ...
            <form id="inward_packing_material" name="inward_packing_material" method="get" action="">
                ...
                <div class="col-12 col-md-6 col-lg-3">
                    ...
                    <!-- <div class="col-12 col-md-6 col-lg-3">
                        <div class="form-group">
                            <input type="date" class="form-control calendar" value="{{old('datefrom', $datefrom)}}"  name="datefrom" id="fromDate" placeholder="Date From">
                    ...
                    <div class="col-12 col-md-6 col-lg-3">
                        ...
                        <a style="color: white;" href="{{ route('annexure_iii') }}">clear</a>
                        </button>
                    </div>
