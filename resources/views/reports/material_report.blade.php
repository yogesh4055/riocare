        ...
        <div class="col-md-12 grid-margin">
            <div class="row page-heading">
                <div class="col-12 col-lg-8 mb-xl-0 align-self-center align-items-center">
                    <h4 class="font-weight-bold d-flex"><i class="menu-icon" data-feather="truck"></i>Raw Material Report</h4>
                </div>
            ...
            <form id="inward_packing_material" name="inward_packing_material" method="get" action="">
                ...
                <div class="col-12 col-md-6 col-lg-3">
                        ...
                        <div class="form-group">
                            <select class="form-control" name="material_name">
                                ...
                                @foreach($search_list as $name)
                                    <option value="{{$name->id}}" <?php if(isset($_GET['material_name']) && $_GET['material_name'] == $name->id) echo 'selected'; ?>>{{$name->material_name}}</option>
                                @endforeach
                                @endif
                            </select>
                        </div>
                    ...
                    <div class="col-12 col-md-6 col-lg-3">
                        ...
                        <a style="color: white;" href="{{ route('material_report') }}">clear</a>
                        </button>
                    </div>
            ...
            <div class="tbl-sticky">
                ...
                <thead>
                        <tr>
                            ...
                            <th rowspan="2">RioCare's Expiry/Retest Date</th>
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>@if($temp->is_opening == 1){{$temp->opening_stock}} @endif</td>
                            <td>{{$temp->man_name}}</td>
                            <td>{{$temp->name}}</td>
